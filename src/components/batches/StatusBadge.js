...
const statusConfig = {
  active: {
    label: 'Active',
    className: 'bg-accent text-white font-semibold px-2 py-0.5 rounded-full text-xs animate-fade-in',
    icon: (
  ...
  completed: {
    label: 'Completed',
    className: 'bg-gray-light text-primary font-medium px-2 py-0.5 rounded-full text-xs animate-fade-in',
    icon: (
  ...
  inactive: {
    label: 'Inactive',
    className: 'bg-gray-light text-gray-dark font-medium px-2 py-0.5 rounded-full text-xs animate-fade-in',
    icon: (
  ...
  warning: {
    label: 'Warning',
    className: 'bg-warning/10 text-warning font-medium px-2 py-0.5 rounded-full text-xs animate-fade-in',
    icon: (
