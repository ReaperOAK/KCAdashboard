...
const ClassroomDetailLoading = React.memo(() => (
  <section className="min-h-screen bg-background-light dark:bg-background-dark flex items-center justify-center p-4 animate-fade-in" aria-busy="true" aria-label="Loading classroom details">
