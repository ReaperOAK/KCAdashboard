...
const LoadingSpinner = React.memo(function LoadingSpinner({ label = 'Loading resources...' }) {
  ...
  return (
    <section className="flex flex-col items-center justify-center py-10 px-4 bg-background-light dark:bg-background-dark rounded-2xl shadow-md w-full max-w-xs mx-auto animate-fade-in" role="status" aria-live="polite">
