...
const ErrorState = React.memo(({ error }) => (
  <section className="flex items-center justify-center min-h-screen bg-background-light dark:bg-background-dark p-4 animate-fade-in" role="alert" aria-live="assertive">
    <div className="text-center w-full max-w-lg">
      <div className="bg-red-700 border border-red-800 text-white px-6 py-4 rounded-2xl mb-4 shadow-lg flex flex-col items-center animate-fade-in">
