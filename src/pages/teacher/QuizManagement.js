...
const QuizTableRow = React.memo(({ quiz, onEdit, onPublish, onDelete, getStatusClass, getDifficultyClass }) => (
  <tr className="border-t hover:bg-gray-light">
    <td className="p-4">
      <div className="font-medium text-secondary">{quiz.title}</div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-8">
          ...
          <button
            ...
            className="px-4 py-2 bg-secondary text-white rounded-md hover:bg-accent flex items-center focus:outline-none focus:ring-2 focus:ring-accent"
        ...
        <div className="bg-white rounded-xl shadow-md mb-8">
          <div className="p-4 border-b flex items-center">
            ...
            <h2 className="text-lg font-semibold text-primary">Filter Quizzes</h2>
          </div>
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              <div className="col-span-2">
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 border border-gray-light rounded-md focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent"
              ...
              <div>
                <select
                  ...
                  className="w-full p-2 border border-gray-light rounded-md focus:outline-none focus:ring-2 focus:ring-accent"
        ...
        <div className="bg-white rounded-xl shadow-md">
          <div className="p-4 border-b flex items-center">
            ...
            <h2 className="text-lg font-semibold text-primary">Your Quizzes</h2>
          </div>
          {loading ? (
            <QuizLoadingSkeleton />
          ) : error ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-light text-primary text-sm uppercase">
