...
const QuizErrorAlert = React.memo(function QuizErrorAlert({ error }) {
  return (
    <div className="w-full max-w-xl mx-auto p-4 sm:p-6 text-center bg-error border border-error rounded-2xl shadow-md flex flex-col items-center gap-2 " role="alert" aria-live="assertive">
