...
const MaterialCard = React.memo(function MaterialCard({ material, handleOpenMaterial }) {
  return (
    <div className="p-4 border border-gray-light rounded-xl shadow-md bg-background-light dark:bg-background-dark hover:shadow-lg transition-all duration-200 animate-fade-in">
