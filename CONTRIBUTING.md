...
Update all relevant docs after code changes. If you change quiz, chess move validation/feedback logic, or attendance batch selection logic, document it in README.md, CHANGELOG.md, and the relevant feature docs.
