...
export const TournamentsApi = {
  getAll: async () => {
    // Returns { tournaments: [...] }
    return await get('/tournaments/get-all.php');
  },
  getByStatus: async (status) => {
    // Returns { tournaments: [...] }
    return await get(`/tournaments/get-by-status.php?status=${status}`);
  },
  ...
  getRegistrations: async () => {
    ...
    return await get('/tournaments/get-registrations.php');
  },
  ...
  initiatePayment: (formData) => post('/tournaments/initiate-payment.php', formData, { isFormData: true }),
