...
const ClassroomNotFound = React.memo(({ onBack }) => (
  <section className="min-h-screen bg-background-light dark:bg-background-dark flex items-center justify-center p-4 ">
    <div className="bg-white dark:bg-background-dark border border-gray-light dark:border-gray-dark p-6 sm:p-8 rounded-2xl max-w-lg w-full text-center shadow-2xl ">
