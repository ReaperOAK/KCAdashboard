...
const FaqModal = React.memo(function FaqModal({ open, onClose, onSubmit, newFaq, setNewFaq }) {
  ...
  return (
    <div
      ...
      ref={modalRef}
    >
      <div className="bg-background-light dark:bg-background-dark rounded-2xl border border-gray-light shadow-2xl p-6 sm:p-8 max-w-lg w-full relative animate-fade-in">
        <button
          onClick={onClose}
