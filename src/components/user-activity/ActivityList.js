...
const ActivityList = React.memo(function ActivityList({ activities }) {
  ...
  return (
    <ul
      className="w-full max-w-2xl mx-auto bg-background-light dark:bg-background-dark rounded-lg shadow-md border border-gray-light divide-y divide-gray-light p-0 sm:p-2 "
