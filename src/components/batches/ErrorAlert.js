...
const ErrorAlert = ({ error, onBack }) => (
  <div className="min-h-screen flex items-center justify-center bg-background-light p-4">
    <div className="w-full max-w-md mx-auto bg-error/10 text-error border border-error p-6 rounded-xl shadow-md flex flex-col items-center animate-fade-in" role="alert">
